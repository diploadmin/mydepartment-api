...
FALLBACK_PROMPT = """\n\nIMPORTANT: If you cannot provide an relevant answer based on the provided context, or your answer is not related to the topics: AI diplomacy, AI governance, AI and philosophy, AI and art, AI and lingusitics, than you should answer that you don't have enough information to provide a response."""
SYSTEM_PROMPT_GUIDE = """
